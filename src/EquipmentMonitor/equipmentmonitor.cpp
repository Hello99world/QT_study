...
EquipmentMonitor::EquipmentMonitor(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::EquipmentMonitor)
{
    ui->setupUi(this);
    // 水平布局
    ...
    QList<QPair<QString, QString>> menuData = {
        {"数据监控", ":/rec/image/shujujiankong.png"},
                                               };
    ...
    stackedWidget->addWidget(datamonitoring);

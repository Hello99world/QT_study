#ifndef POLICERECORD_H
#define POLICERECORD_H
...
class PoliceRecord : public QWidget
{
    Q_OBJECT

public:
    explicit PoliceRecord(QWidget *parent = nullptr);
    ~PoliceRecord();
